...
import com.example.customlistview.databinding.ActivityDeatailedBinding;

public class DeatailedActivity extends AppCompatActivity {

    ActivityDeatailedBinding binding;
